...
import com.ngntu10.security.Authorize;
import com.ngntu10.service.Auth.AuthenticationService;
    ...
    private void validateQueryParams(final HttpServletRequest request, final HandlerMethod handler) {
        ...
        for (MethodParameter methodParameter : methodParameters) {
            ...
            if (requestParam != null) {
                String paramName = StringUtils.hasText(requestParam.name()) ? requestParam.name() : methodParameter.getParameterName();
                expectedParams.add(paramName);
                if (requestParam.required() && !queryParams.contains(paramName)) {
